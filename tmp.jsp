...
function beforeSendComments() {
 ...
 return true;
  ...
  <div class="toptop">
    <ul class="minitop">
      <li>
        <a href="../pages/member.html" class="sign_in" alt="會員專區">
   ...
   "jdbc:mysql://localhost:3306/shoe_shop","i4m","syscom");  
  ...
  <div class="conta">
    <div class="comment-send">
      <form id="commentForm" method="POST" action="ReqHandler.jsp" onsubmit="return beforeSendComments()";>
        ...
        <pre style="margin-left: 600px;">評分: <input name="starcount" type="number" min="1" max="5" value="5" style="width:30px; 
